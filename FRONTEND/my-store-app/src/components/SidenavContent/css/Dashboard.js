...
function Dashboard() {
  ...
  const fetchDiary = async () => {
    ...
    setDiary(data);
    setDiary01(data);
    setDiary1(data.filter((item) => item.trangthai === "đúng hạn"));
    setDiary2(data.filter((item) => item.trangthai === "trễ hạn"));
    setDiary3(data.filter((item) => item.trangthai === "còn hạn"));
    setDiary4(data.filter((item) => item.trangthai === "hết hạn"));
